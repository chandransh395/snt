        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-travel-gold transition-colors">
          ...
          <div>
            ...
            <address className="not-italic">
              <div className="flex items-start space-x-3 mb-4">
                ...
                <span className="text-gray-300">123 Travel Street, Suite 100<br />New York, NY 10001</span>
              </div>
              <div className="flex items-start space-x-3 mb-4">
                <svg className="h-6 w-6 text-travel-gold flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
